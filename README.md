# Title : [Adview](http://13.231.193.107:8080/portfolio)
...
業務の中で使っていた予約管理ツールのUIとカレンダー機能などに改善できる点があると感じていたため、自らで作ってみようと思ったため。
...
- ユーザーが使いたくなるUIとはどんなものかを考え、シンプルで使いやすいデザインをフレームワーク・ライブラリを使用して実現した点
- 知人に頼んで実際にアプリケーションを使用してもらい、フィードバックをもらいながら改修をするサイクルを繰り返している点
...
## 使い方
- ユーザー画面(http://13.231.193.107:8080/portfolio). ~~※現在停止中~~
  - 商品表示・検索機能
...
- 管理者画面(http://13.231.193.107:8080/portfolio/admin).  ~~※現在停止中~~
