...
INSERT INTO products (product_id, product_name, product_image, category_id, destination_id, delete_flag, price) VALUES (1, 'dummyName1', 'dummyImage1',  1, 1, false, 1000);
INSERT INTO products (product_id, product_name, product_image, category_id, destination_id, delete_flag, price) VALUES (2, 'dummyName2', 'dummyImage2', 2, 2, false, 1000);
INSERT INTO products (product_id, product_name, product_image, category_id, destination_id, delete_flag, price) VALUES (3, 'dummyName3', 'dummyImage3', 3, 1, false, 1000);
INSERT INTO products (product_id, product_name, product_image, category_id, destination_id, delete_flag, price) VALUES (4, 'dummyName4', 'dummyImage4', 3, 2, false, 1000);
